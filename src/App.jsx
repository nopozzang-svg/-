  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <div style={{
        ...
        <div style={{
          position: "absolute", left: `${avgPos}%`,
          top: -3, width: 2, height: 14,
          background: "#ff9f43", borderRadius: 1, zIndex: 2,
        }} />
        <div style={{
          position: "absolute", left: `${sailPos}%`,
        ...
        {group.competitors.map((c, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              top: 0, width: 8, height: 8, borderRadius: "50%",
              background: "#555d6e", transform: "translateX(-50%)", zIndex: 1,
            }} />
          );
        })}
      </div>
  ...
  <div className="sail-logo-wrap">
    <div className="sail-logo-badge">
      ...
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        ...
        />
        <path
          d="M12 6C12 6 8 12 8 15a4 4 0 0 0 8 0C16 12 12 6 12 6Z"
          fill="rgba(28,110,245,0.6)"
        />
      </svg>
    </div>
          ...
          <>
              ...
              <ResponsiveContainer width="100%" height={240}>
                <BarChart data={compChartData} barGap={4} margin={{ top: 5, right: 10, left: -15, bottom: 5 }}>
                  ...
                  <YAxis
                    ...
                    tick={{ fill: "#7a8599", fontSize: 10, fontFamily: "'JetBrains Mono', monospace" }}
                    axisLine={false} tickLine={false}
                  />
                  <Tooltip
                    contentStyle={{ background: "#1a1e2a", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, fontSize: 12, color: "#f0f2f5" }}
            ...
            <div className="dash-panel">
              <div className="panel-header">
                ...
                <div className="legend-group">
                  <span className="legend-item">
                    <span style={{ width: 10, height: 10, borderRadius: "50%", background: "#3db88c", display: "inline-block" }} /> 평균 이하
                  </span>
                  <span className="legend-item">
                    <span style={{ width: 10, height: 10, borderRadius: "50%", background: "#e85d5d", display: "inline-block" }} /> 평균 이상
                  </span>
                  <span className="legend-item">
                    <span style={{ width: 2, height: 10, background: "#ff9f43", display: "inline-block" }} /> 전국 평균
                  </span>
                  <span className="legend-item">
                    <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#555d6e", display: "inline-block" }} /> 경쟁사
                  </span>
                </div>
              </div>
              {data.groups.map((g, i) => (
